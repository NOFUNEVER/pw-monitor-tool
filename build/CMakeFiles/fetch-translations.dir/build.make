...
CMakeFiles/fetch-translations: releaseme
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/eos_jlamphere/pw-monitor-tool-dev/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Downloading translations for plasmoid-pw_monitor_tool branch trunk..."
	git -C /home/eos_jlamphere/pw-monitor-tool-dev/build/releaseme pull
	cmake -E remove_directory /home/eos_jlamphere/pw-monitor-tool-dev/build/po
	cmake -E remove_directory /home/eos_jlamphere/pw-monitor-tool-dev/build/poqm
	ruby /home/eos_jlamphere/pw-monitor-tool-dev/build/releaseme/fetchpo.rb --origin trunk --project plasmoid-pw_monitor_tool --output-dir /home/eos_jlamphere/pw-monitor-tool-dev/build/po --output-poqm-dir /home/eos_jlamphere/pw-monitor-tool-dev/build/poqm /home/eos_jlamphere/pw-monitor-tool-dev

releaseme:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/eos_jlamphere/pw-monitor-tool-dev/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Fetching releaseme scripts to download translations..."
